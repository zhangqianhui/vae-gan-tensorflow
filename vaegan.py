...
class vaegan(object):
    ...
    def test3(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            train_list = CelebA.getNextBatch(self.ds_train, np.inf, 13, self.batch_size)
            realbatch_array = CelebA.getShapeForData(train_list)

            print realbatch_array.shape
    ...
    def Encode(self, x):
        ...
        with tf.variable_scope('encode') as scope:
            ...
            z_mean = batch_normal(fully_connect(conv3 , output_size=1024, scope='e_f4'), scope='e_bn4')
            z_sigma = batch_normal(fully_connect(conv3, output_size=1024, scope='e_f5'), scope='e_bn5')
