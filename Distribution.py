...
class Categorical(Distribution):
    ...
    def logli(self , x_var , dist_info):
        ...
        #x_var shape = [3,10]
        #dist_info shape = [3,10]

        #dist_info = tf.Print(dist_info , [dist_info] , message="dist_info:")
        #dist_info.eval()
...
class Uniform(Gaussian):
    ...
    def sample_prior(self, batch_size):
        #return tf.random_normal([batch_size , self.dim], mean=0.0, stddev=1)
        return tf.random_normal([batch_size, self.dim], mean=0, stddev= 0.01)
